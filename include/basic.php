...
function myPDOexecute($stmt, $param = null)
{
 ...
 //////////////////////////////
 // Get Location in latitude longitude
 ////////////////////////////////

    function getLocationByText($s){
        $geocode=file_get_contents('http://maps.google.com/maps/api/geocode/json?sensor=true&address='.urlencode($s));
        //var_dump($geocode);
        //echo "<pre>$geocode</pre>";
        $output= json_decode($geocode);
        //var_dump($output);
        $out->text = $output->results[0]->formatted_address;
